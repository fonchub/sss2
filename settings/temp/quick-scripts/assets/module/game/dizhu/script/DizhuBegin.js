(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/game/dizhu/script/DizhuBegin.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cc414fafx1EfIEhdfVAesnW', 'DizhuBegin', __filename);
// module/game/dizhu/script/DizhuBegin.js
...
cc.Class({
    ...
    recovery_event: function recovery_event(data, context) {
        ...
        for (var inx = 0; inx < mycards.length; inx++) {
            var _pokencard = context.playcards(context.game, context, inx * 50 - 300, mycards[inx]);
         ...
         */
        if (data.last != null) {
            var lastcards = context.decode(data.last.cards); //解析牌型
    ...
    lasthands_event: function lasthands_event(data, context) {
        ...
        if (data.userid == cc.beimi.user.id) {
            ...
            for (var i = 0; i < lasthands.length; i++) {
                ...
                var _pc = context.current(context.game, context, 2 * 300 + (6 + i) * 50 - 300, lasthands[i], func);
    ...
    play_event: function play_event(data, context) {
        ...
        var left = context.game.pokerpool.get(),
    ...
    otherplayer: function otherplayer(currpoker, inx, num, game, self) {
        if (inx == 0) {
            var seq = cc.sequence(cc.spawn(cc.moveTo(0.2, -350, 50), cc.scaleTo(0.2, 0.3, 0.3)), cc.moveTo(0, 0, 200), cc.scaleTo(0, 1, 1));
            currpoker.runAction(seq);
        } else {
            var _seq = cc.sequence(cc.spawn(cc.moveTo(0.2, 350, 50), cc.scaleTo(0.2, 0.3, 0.3)), cc.moveTo(0, 0, 200), cc.scaleTo(0, 1, 1));
    ...
    current: function current(game, self, posx, card, func) {
        ...
        if (func != null) {
            var seq = cc.sequence(cc.moveTo(0.2, posx, -180), func);
            currpoker.runAction(seq);
        } else {
            var action = cc.moveTo(0.2, posx, -180);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=DizhuBegin.js.map
