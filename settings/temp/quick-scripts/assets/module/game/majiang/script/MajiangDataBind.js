(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/game/majiang/script/MajiangDataBind.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd95a8lKtJpJP42PDp+oYIJT', 'MajiangDataBind', __filename);
// module/game/majiang/script/MajiangDataBind.js
...
cc.Class({
    ...
    recover_desk_cards: function recover_desk_cards(userid, card, context) {
        if (userid == cc.beimi.user.id) {
            ...
            var cardpanel = void 0,
                cardprefab = void 0,
                deskcardpanel = void 0;
            if (_temp2.tablepos == "right") {

                cardpanel = context.right_panel;
                cardprefab = context.takecards_right;
                deskcardpanel = context.deskcards_right_panel;
            } else if (_temp2.tablepos == "left") {

                cardpanel = context.left_panel;
                cardprefab = context.takecards_left;
                deskcardpanel = context.deskcards_left_panel;
            } else if (_temp2.tablepos == "top") {
        ...
        if (cc.beimi.user.id == data.userid) {
            ...
            if (data.deal == true) {
                ...
                if (data.gang == true || data.peng == true || data.chi == true || data.hu == true) {
                    ...
                    if (data.gang) {
                        gang.active = true;actionNum = actionNum + 1;
                    }
                    if (data.peng) {
                        peng.active = true;actionNum = actionNum + 1;
                    }
                    if (data.chi) {
                        chi.active = true;actionNum = actionNum + 1;
                    }
                    if (data.hu) {
                        hu.active = true;actionNum = actionNum + 1;
                    }
                    if (data.deal == false) {
                        guo.active = true;
    ...
    selectaction_event: function selectaction_event(data, context) {
        ...
        if (cc.beimi.user.id == data.userid) {
            ...
            var _temp8 = context.player(data.target, context),
                deskcardpanel = void 0;
            if (_temp8.tablepos == "right") {
                deskcardpanel = context.deskcards_right_panel;
            } else if (_temp8.tablepos == "left") {
                deskcardpanel = context.deskcards_left_panel;
            } else if (_temp8.tablepos == "top") {
                deskcardpanel = context.deskcards_top_panel;
            }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=MajiangDataBind.js.map
